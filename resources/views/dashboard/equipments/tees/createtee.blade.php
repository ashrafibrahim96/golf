    ...
    <div class="col-md-12">
        <div class="card card-user">
            <div class="card-header">
                <h5 class="card-title">Add Tee</h5>
            </div>
            @if ($errors->any())
                ...
                <form action="{{ route('tee.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 px-1">
                            <div class="form-group">
                                <label>Hauteur</label>
                                <input type="text" name="hauteur" class="form-control" placeholder="Hauteur">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="update ml-auto mr-auto">
                        <button type="submit" class="btn btn-primary btn-round">Add Tee</button>
                    </div>
                </form>
            </div>
        </div>
